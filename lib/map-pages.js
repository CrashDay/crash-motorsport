...
const SEBRING_GEOJSON_URL = new URL("../public/maps/sebring.geojson", import.meta.url);
const DANIELS_PARK_GEOJSON_URL = new URL("../public/maps/daniels-park.geojson", import.meta.url);

const STATIC_MAP_DATA = {
  sebring: {
    geoJsonUrl: SEBRING_GEOJSON_URL,
    photoMarkers: [],
  },
  "daniels-park": {
    geoJsonUrl: DANIELS_PARK_GEOJSON_URL,
    photoMarkers: danielsPhotoMarkers,
  },
};

function readStaticGeoJson(fileUrl) {
...
function hydrateStaticMapPage(config) {
  ...
  return {
    ...config,
    mapGeoJson: staticData.geoJsonUrl ? readStaticGeoJson(staticData.geoJsonUrl) : null,
