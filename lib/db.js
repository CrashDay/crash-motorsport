...
function assignAreaAsset(db, { track_id, area_id, asset_id, asset_name, thumb_url, full_url, year, assigned_at }) {
  db.prepare(`
  ...
  `).run(track_id, area_id, asset_id, asset_name, thumb_url, full_url, year ?? null, assigned_at);
}
